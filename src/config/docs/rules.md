...
- [Schema Properties](#schema-properties)
  ...
  - [`alert`](#alert)
    - [`alert.on`](#alerton)
      - [`alert.on.count`](#alertoncount)
      - [`alert.on.interval`](#alertoninterval)
      - [`alert.on.label`](#alertonlabel)
      - [`alert.on.value`](#alertonvalue)
      - [`alert.on.valueMatch`](#alertonvaluematch)
      - [`alert.on.percentThreshold`](#alertonpercentthreshold)
    - [`alert.template`](#alerttemplate) (See [Templates](./templates.md))
    - [`alert.severity`](#alertseverity)
    - [`alert.throttle`](#alertthrottle) (See [Throttle](./throttle.md))
